...
export class MiniElysiumBoard extends Board {
  public static newInstance(shuffle: boolean, rng: Random, includeVenus: boolean): MiniElysiumBoard {
    ...
    // y=4
    builder.land(PLANT, PLANT, STEEL).land(PLANT, PLANT).land(PLANT, PLANT).land(PLANT, PLANT).land(PLANT, PLANT, PLANT).land(PLANT, PLANT).land(PLANT, TITANIUM);
    // y=5
    builder.land(PLANT, TITANIUM).land(PLANT, STEEL).land(PLANT).land(PLANT).land(PLANT).land(PLANT);
    // y=6
