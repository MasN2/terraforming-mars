...
export class MiningGuild extends Card implements CorporationCard {
  constructor() {
    super({
      ...
      metadata: {
        cardNumber: 'R24',
        description: 'You start with 37 M€. As your first action, place this tile on a location with a STEEL bonus.',
        renderData: CardRenderer.builder((b) => {
          b.br.br;
          b.megacredits(37).nbsp.tile(TileType.MINING_RIGHTS, true).asterix();
          b.corpBox('effect', (ce) => {
