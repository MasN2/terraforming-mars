  ...
  methods: {
    getHtmlContent: function(): string {
      ...
      case CardName.FUEL_GREEN:
        return '<div class="card-fuel-green-logo">Fuel <span style="color:green">GREEN</span></div>';
      ...
      case CardName.IMPACT:
        return '<div class="card-impact-logo">IMP⚠CT</div>';
      case CardName.UNITED_NATIONS_MAGNETIZER_PROJECT:
        return '<div class="card-morning-star-logo">UN Magnetizer Project</div>';
      case CardName.COMMON_CAUSE:
        return '<div class="card-morning-star-logo">Common Cause</div>';
      case CardName.SOLAR_WIND:
        return '<div class="card-morning-star-logo">Solar Wind</div>';
      case CardName.GANYMEDE_ASSOCIATION:
        return '<div class="card-morning-star-logo">Ganymede Association</div>';
      }
      return '';
    },
  },
